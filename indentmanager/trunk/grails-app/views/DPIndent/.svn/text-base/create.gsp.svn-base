...
<body>
<a href="#create-DPIndent" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<div id="create-DPIndent" class="content scaffold-create" role="main">
