...
<body>
<a href="#edit-shippingAdvice" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<div id="edit-shippingAdvice" class="content scaffold-edit" role="main">
    ...
    <g:form method="post">
        ...
        <g:hiddenField name="version" value="${shippingAdviceInstance?.version}"/>
        <fieldset class="form">
