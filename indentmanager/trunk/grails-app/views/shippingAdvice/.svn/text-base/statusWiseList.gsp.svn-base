...
<div id="list-shippingAdvice" class="content scaffold-list" role="main">
    ...
    <g:form action="statusWiseList" name="statusWiseListForm">
        <div class="nav" role="navigation">
            <ul>
                <li>Status:</li>
                <li>
                    <g:select id="shippingAdviceStatusId" name="shippingAdviceStatusId" from="${ShippingAdviceStatus.list()}" optionKey="id" optionValue="name"
                              ...
                              onchange="document.getElementById('statusWiseListForm').submit();"/>
                </li>
                <li>
                    <export:formats formats="['csv']" params="[shippingAdviceStatusId:shippingAdviceStatusId]" class="csvexport"/>
                </li>
    ...
    <table>
        ...
        <tr>
            <g:sortableColumn property="indent.indentIdentifier" title="${message(code: 'shippingAdvice.indentIdentifier.label', default: 'Indent Identifier')}"
                              params="[shippingAdviceStatusId:shippingAdviceStatusId]"/>
    ...
    <div class="pagination">
        <g:paginate total="${shippingAdviceInstanceTotal}" params="[shippingAdviceStatusId:shippingAdviceStatusId]"/>
    </div>
</div>
</body>
</html>
