...
<html>
	...
	<body>
		<a href="#list-paymentTerm" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-paymentTerm" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${paymentTermInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
