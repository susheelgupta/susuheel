...
<body>
<a href="#create-LCIndent" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<div id="create-LCIndent" class="content scaffold-create" role="main">
