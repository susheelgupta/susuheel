<%@ page import="com.snehinternational.indentmanager.UserRole" %>
...
<div class="fieldcontain ${hasErrors(bean: userRoleInstance, field: 'role', 'error')} required">
    ...
    <g:select id="role" name="role.id" from="${com.snehinternational.indentmanager.Role.list()}" optionKey="id" optionValue="authority" required=""
...
<div class="fieldcontain ${hasErrors(bean: userRoleInstance, field: 'user', 'error')} required">
    ...
    <g:select id="user" name="user.id" from="${com.snehinternational.indentmanager.User.list()}" optionKey="id" optionValue="username" required=""
