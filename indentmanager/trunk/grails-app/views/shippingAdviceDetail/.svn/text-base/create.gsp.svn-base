...
<body>
<a href="#create-shippingAdviceDetail" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<div id="create-shippingAdviceDetail" class="content scaffold-create" role="main">
